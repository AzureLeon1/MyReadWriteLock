...
namespace MyReadWriteLock2 {
    ...
    internal class ReaderWriterCount {
        ...
        //    The "hot" paths in MyReadWriteLock2 are short enough that this actually
        //    matters.
        public long lockID;

        // How many reader locks does this thread hold on this MyReadWriteLock2 instance?
    ...
    public class MyReadWriteLock2 : IDisposable {
        ...
        // instance of MyReadWriteLock2.  It does NOT protect the memory associated with 
        ...
        public MyReadWriteLock2() : this(LockRecursionPolicy.NoRecursion) { }

        public MyReadWriteLock2(LockRecursionPolicy recursionPolicy) {
